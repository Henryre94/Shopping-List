    ...
    <div>
        ...
        >
            ...
            <template #item.actions="{ item }">
                <v-icon large color="black" class="mr-6" @click.stop="editItem(item)"> mdi-pencil </v-icon>
                <v-icon large color="red" class="mr-6" @click.stop="deleteItem(item)"> mdi-delete </v-icon>
                <v-icon large color="blue" class="mr-6" @click="shoppingList(item)"> mdi-cart-plus </v-icon>
            </template>
        </v-data-table>
        <BottomBar></BottomBar>
    </div>
