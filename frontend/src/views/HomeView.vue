<template>
    <div>
        <TheHeader></TheHeader>
        <h1>Cafe Saadi Einkaufsliste</h1>

        <v-card height="100%" width="100%">
            <v-navigation-drawer class="blue-grey darken-4" dark permanent width="100%" height="100%">
                <v-list>
                    <v-list-item v-for="item in items" :key="item.title" link>
                        <v-list-item-icon>
                            ...
                            <router-link style="text-decoration: none; color: white" to="/login"
                                ><v-icon x-large color="white">{{ item.iconLogin }}</v-icon></router-link
                            >
                        </v-list-item-icon>

                        <v-list-item-content>
                            <router-link style="text-decoration: none; color: white; font-size: large" to="/haendler"
                                ><v-list-item-title>{{ item.titleStore }} </v-list-item-title></router-link
                            >
                            <router-link style="text-decoration: none; color: white; font-size: large" to="/pub"
...
export default {
    ...
    data() {
        return {
            items: [
                { titleStore: "Händler", iconStore: "mdi-store" },
                { title1090: "Cafe 1090", icon1090: "mdi-silverware-variant" },
