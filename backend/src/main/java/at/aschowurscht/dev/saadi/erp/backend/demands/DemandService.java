...
//        Credential credential = credentialRepository.findByEmail(authenticationFacade.getAuthentication().getName());
//        if (credential == null)
...
//        Customer customer = (Customer) getAccount();


    public DemandDTO createDemand(int proId, Pub pub) {
